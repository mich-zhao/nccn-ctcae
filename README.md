# DATA H195 Honors Project - NCCN Distress Thermometer and CTCAE Symptoms

_Michelle Zhao_

[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ls88-openscienceconnector/final-project/master)

In this project, I will aim to primarily statistically analyze the National Comprehensive Cancer Network's (NCCN) Distress Thermometer (DT) screening data and EHR data, both structured and unstructured, to assess if there are disparities in (1) patient and provider completion of the NCCN DT and (2) National Cancer Institute (NCI) Common Terminology Criteria for Adverse Events (CTCAE) symptoms extracted using the Apache clinical Text Analysis Knowledge Extraction System (cTAKES) pipeline as a cancer patient. For more detailed information, see my [Pre-Analysis Plan](notebooks/pre-analysis-plan.ipynb).
